...
var signin_get = function() {
	...
	exports.handle = function(request, response) {
		var parsed = _urlParser.parse(request.url, true); 
		_userRepository.getByEmailAndPassword(parsed.query.emailAddress, parsed.query.password, {
